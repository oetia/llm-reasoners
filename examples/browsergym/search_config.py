...
class SearchConfigBrowsergym(SearchConfig):
    ...
    def __init__(self,
        ...
        self.action_proposal_times = []
        self.action_evaluation_times = []
    ...
    def get_actions(self, state: StateGym) -> list[ActionGym]:
        ...
        self.action_proposal_times.append(end - start)
    ...
    def fast_reward(self, state: StateGym, action: ActionGym) -> tuple[float, dict]:
        ...
        self.action_evaluation_times.append(end - start)
        print(f"Action evaluation time: {end - start}")
    ...
    def get_stats(self) -> dict:
        """
        Get time statistics for the SearchConfig.
        """

        return {
            "action_proposal_times": self.action_proposal_times,
            "action_evaluation_times": self.action_evaluation_times,
        }
